...
<><script src="https://apis.google.com/js/platform.js" async defer></script><div id="google-signin-button"></div><script>
  ...
  function onFailure(error) {console.error('Google Sign-In failed:', error)};
  

  function renderButton() {gapi.signin2.render('google-signin-button', {
    'scope': 'email', // Specify the scopes your app needs
    'width': 200, // Customize the button width
    'height': 50, // Customize the button height
    'longtitle': true, // Display long button text
    'theme': 'light', // Customize the button theme (light/dark)
    'onsuccess': onSignIn,
    'onfailure': onFailure
  })};
  

  window.onload = function () {renderButton()};
  ;
</script></>
